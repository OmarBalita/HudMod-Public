...
#class_name DrawEditControl extends Control
#
...
#func _ready_draw_ui() -> void:
	...
	#custom_properties_check_button = IS.create_bool_edit("Custom Properites", false).controller
	#custom_color_button = IS.create_color_edit("Line Color", draw_edit.custom_line_color).controller
	#custom_fill_color_button = IS.create_color_edit("Fill Color", draw_edit.custom_fill_color).controller
...
#func _ready_edit_ui() -> void:
	...
	#
	#proportional_edit_check_button = IS.create_bool_edit("Proportional Edit", false).controller
	...
	#proportional_edit_connected_only_button = IS.create_bool_edit("Connected Only", false).controller
	#
