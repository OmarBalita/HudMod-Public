...
func draw_new_dashed_line(from: Vector2, to: Vector2, color: Color = Color.WHITE, width: float = 1.0, dash: int = 2, aligned: bool = true) -> int:
...
func draw_new_selection_box_rect(rect: Rect2, color: Color = IS.color_accent) -> void:
	...
	draw_new_dashed_line(start_pos, to_x_pos, color, 2., 10., true)
	draw_new_dashed_line(to_x_pos, end_pos, color, 2., 10., true)
	draw_new_dashed_line(end_pos, to_y_pos, color, 2., 10., true)
	draw_new_dashed_line(to_y_pos, start_pos, color, 2., 10., true)
