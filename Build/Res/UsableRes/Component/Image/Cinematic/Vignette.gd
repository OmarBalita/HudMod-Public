...
@export var vignette_texture:= DisplayFileSystemPath.new_sys_path(0, false)
...
func _get_exported_props() -> Dictionary[StringName, ExportInfo]:
	return {
		...
		&"vignette_texture": export([vignette_texture]),
...
func _process(frame: int) -> void:
	set_shader_props({
		...
		&"vignette_texture": vignette_texture.get_file_media(),
