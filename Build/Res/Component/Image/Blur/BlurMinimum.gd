...
## GPLv3                                                                   ##
#############################################################################
class_name CompBlurMin extends PassShaderComponentRes
...
static func _shader() -> Shader:
	return preload("res://Build/Shader/Image/BlurMinimum.gdshader")
